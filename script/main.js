...
function generateRandomTransaction() {
  ...
  return {
    ...
    burned: (Math.random() * (300000 - 1000) + 1000).toFixed(6),
    currency:
...
function scheduleNextUpdate() {
  const delay = Math.floor(Math.random() * 5000) + 5000; // Random delay between 5000 and 10000 ms
  setTimeout(() => {
    updateTransactions();
    scheduleNextUpdate();
  }, delay);
